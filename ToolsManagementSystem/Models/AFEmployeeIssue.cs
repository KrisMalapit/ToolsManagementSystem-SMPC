...
namespace ToolsManagementSystem.Models
{
    public class AFEmployeeIssue
    {
        ...
        public virtual ICollection<AFEmployeeReturn> AFEmployeeReturns { get; set; }
        public virtual AFEmployee AFEmployees { get; set; }
        public virtual Item Items { get; set; }

        public AFEmployeeIssue()
        {
            Status = "Active";
